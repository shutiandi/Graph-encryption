...
dictrenumone={3: 5, 4: 3, 5: 4, 12: 37, 35: 12, 37: 35, 16: 34, 30: 16, 34: 30, 56: 106, 90: 56, 106: 90, 65: 97, 72: 65, 97: 72, 66: 110, 88: 66, 110: 88, 69: 115, 92: 69, 115: 92, 75: 125, 100: 75, 125: 100, 85: 157, 132: 85, 157: 132, 104: 185, 153: 104, 185: 153, 105: 233, 208: 105, 233: 208, 120: 255, 225: 120, 255: 225, 123: 205, 164: 123, 205: 164, 130: 194, 144: 130, 194: 144, 140: 221, 171: 140, 221: 171, 141: 235, 188: 141, 235: 188}
dictrenumone1={3: 4, 4: 5, 5: 3, 12: 35, 35: 37, 37: 12, 16: 30, 30: 34, 34: 16, 56: 90, 90: 106, 106: 56, 65: 72, 72: 97, 97: 65, 66: 88, 88: 110, 110: 66, 69: 92, 92: 115, 115: 69, 75: 100, 100: 125, 125: 75, 85: 132, 132: 157, 157: 85, 104: 153, 153: 185, 185: 104, 105: 208, 208: 233, 233: 105, 120: 225, 225: 255, 255: 120, 123: 164, 164: 205, 205: 123, 130: 144, 144: 194, 194: 130, 140: 171, 171: 221, 221: 140, 141: 188, 188: 235, 235: 141}

# for i in renumlistone:
    # for j in range(i):
    # dictrenumone[i[0]]=i[2]
    # dictrenumone[i[1]]=i[0]
    # dictrenumone[i[2]]=i[1]

    # dictrenumone1[i[0]] = i[1]
    # dictrenumone1[i[1]] = i[2]
    # dictrenumone1[i[2]] = i[0]
# print(dictrenumone1)
dictnumone={3: 4, 4: 5, 5: 3, 12: 35, 35: 37, 37: 12, 16: 30, 30: 34, 34: 16, 56: 90, 90: 106, 106: 56, 65: 72, 72: 97, 97: 65, 66: 88, 88: 110, 110: 66, 69: 92, 92: 115, 115: 69, 75: 100, 100: 125, 125: 75, 85: 132, 132: 157, 157: 85, 104: 153, 153: 185, 185: 104, 105: 208, 208: 233, 233: 105, 120: 225, 225: 255, 255: 120, 123: 164, 164: 205, 205: 123, 130: 144, 144: 194, 194: 130, 140: 171, 171: 221, 221: 140, 141: 188, 188: 235, 235: 141}
dictnumone1={3: 5, 4: 3, 5: 4, 12: 37, 35: 12, 37: 35, 16: 34, 30: 16, 34: 30, 56: 106, 90: 56, 106: 90, 65: 97, 72: 65, 97: 72, 66: 110, 88: 66, 110: 88, 69: 115, 92: 69, 115: 92, 75: 125, 100: 75, 125: 100, 85: 157, 132: 85, 157: 132, 104: 185, 153: 104, 185: 153, 105: 233, 208: 105, 233: 208, 120: 255, 225: 120, 255: 225, 123: 205, 164: 123, 205: 164, 130: 194, 144: 130, 194: 144, 140: 221, 171: 140, 221: 171, 141: 235, 188: 141, 235: 188}
# for i in renumlistone:
    # for j in range(i):
    # dictrenumone[i[0]]=i[1]
    # dictrenumone[i[1]]=i[2]
    # dictrenumone[i[2]]=i[0]

    # dictrenumone1[i[0]] = i[2]
    # dictrenumone1[i[1]] = i[0]
    # dictrenumone1[i[2]] = i[1]
# print(dictrenumone1)
...
renumlistthree=[
    [[39,80,89],[18,80,82],[80,84,116]]#3选1个来使用，不可同时使用
]

# dictonezhuan={}


# "废墟求生：我能让万物无限进化1-4163.txt"

# print(len(renumlisttwo))
# for i in renumlistone:
#
...
file1rd=open(file="filename.txt",mode="rb")
file1wd=open(file="filename1.txt",mode="wb")
while True:
    fword=file1rd.read(1)
    if len(fword)!=1:
        break
    try:
        sw=dictrenumone1[dict256[fword]]
        if sw:
            file1wd.write(sw.to_bytes(length=1,byteorder="little"))
            continue
    except KeyError:
        pass
    file1wd.write(fword)
...
file1rd=open(file="filename1.txt",mode="rb")
file1wd=open(file="filename2.txt",mode="wb")
while True:
    fword=file1rd.read(1)
    if len(fword)!=1:
        break
    try:
        sw=dictnumone1[dict256[fword]]
        if sw:
            file1wd.write(sw.to_bytes(length=1,byteorder="little"))
            continue
    except KeyError:
